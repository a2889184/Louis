...
// 	cout << m_1 << endl;
 ...
 // 	cout << "P" << endl;
	...
	print_mat(U_1, "split_50/U_1.txt");
	print_mat(V_1, "split_50/V_1.txt");
	print_mat(D_1, "split_50/D_1.txt");
	print_mat(U_2, "split_50/U_2.txt");
	print_mat(V_2, "split_50/V_2.txt");
	print_mat(D_2, "split_50/D_2.txt");
